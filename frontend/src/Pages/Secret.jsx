...
export default function Secret() {
	...
	const [newTodoItemDto, setNewTodoItemDto] = useState({
		name: "",
	})
	...
	const handleEditList = (event) => {
		if (event.target.localName == "svg") {
			...
			dispatch(
				edittodoThunk({
					id: event.target.attributes[4].nodeValue,
					edit: editList.edit,
				}),
			)
			...
			dispatch(
				edittodoThunk({
					id: event.target.nearestViewportElement.nextSibling.id,
					edit: editList.edit,
				}),
			)
		...
		<div style={{ border: "soild 2px black", padding: "11px" }}>
			...
			<Fade in={true} appear={true} timeout={100000}>
				<h1
					...
					className="h1card-subtitle text-muted text-center"
				>
					To do List
				</h1>
			</Fade>
			...
			<div>
				<div className="input-group">
					...
					<div className="input-group-append">
						<Button
							onClick={() =>
								dispatch(addtodoThunk(newTodoItemDto))
							}
							variant="dark"
						>
							add
			...
			>
				Click the text to delete
				<br /> Type sth and click the pen to update
			</p>
			...
			<div style={{ marginTop: "10px" }}>
				<input
					...
					type="text"
					name="edit"
					placeholder="edit something here ..."
